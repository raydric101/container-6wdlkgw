...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6wdlkgw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6wdlkgw.containers.anotherwebservice.com/
...
```
git clone git@github.com:raydric101/container-6wdlkgw.git
cd container-6wdlkgw
```
...
```
docker attach container-6wdlkgw
```
